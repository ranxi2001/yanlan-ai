...
> 2026-09-08 补充：[言澜追平飞书妙记：样本复盘、开源对照与补齐计划](feishu-parity-gap-plan-2026-09-08.md)。该文基于真实导出样本和固定版本开源源码，补充摘要综合、说话人/时间对齐、阅读稿及内容质量验收；其中对 Meetily 的参考范围和摘要 finalizer 的设计提出了进一步调整。
