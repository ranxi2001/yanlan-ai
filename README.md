...
言澜是一个纯前端、可自行部署的开源 AI 语音记录工具，支持普通会议和面试专用模式。它采用双模型管线：MiMo 负责语音识别，GPT 结合会议或岗位上下文校正专有名词和前后不一致，再生成会议纪要或带时间证据的面试辅助评估。
...
`v0.2.0` 增加了面试专用模式、岗位能力证据、面试追问和隐私裁剪后的分享稿。下一阶段重点包括说话人分离、逐字稿编辑、协作批注、团队权限和更多模型适配。路线和优先级通过 GitHub Issues 公开维护。
